<template>
  <div class="main-content">
    <div class="container">
          <h1 class="text-center font-weight-normal text-capitalize">Hoşgeldin Cihan Yılmaz,</h1>
          <h1 class="text-center font-weight-normal gradient-color m-auto">Başlamak için kurslarımıza bir göz atın</h1>
        <div class="mt-5 pt-5">
         <div class="pr-4">
          ...
          <VueSlickCarousel v-bind="settings">
            <div class="mb-4">
             ...
             <div class="mb-4">
               <article class="card position-relative">
                       <span class="badge badge-success position-absolute left-0 top-0 mt-2 ml-2">Popüler</span>
                       <b-dropdown
                              id="dropdown-right"
                              right
                              text="Right align"
